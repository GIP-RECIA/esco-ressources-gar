...
public class GARWSTest {
	...
	public void testGetRessources() {
		...
		Assert.assertTrue(wsc.getRessources("0455006X", "F1300m75").isStatut());
		Assert.assertTrue(wsc.getRessources("0455006X", "F1300m75").getRessources().size() >= 2);
	}
